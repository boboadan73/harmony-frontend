...
const TEXTS = {
  en: {
    ...
    missingEventId: 'Missing event link.',
    acceptPolicyError: 'Please accept Terms & Privacy.',
    continue: 'Continue',
  ...
  ar: {
    ...
    missingEventId: 'رابط الفعالية غير موجود أو غير صالح.',
    acceptPolicyError: 'يرجى الموافقة على الشروط وسياسة الخصوصية.',
    continue: 'متابعة',
  ...
  he: {
    ...
    missingEventId: 'חסר קישור אירוע תקין.',
    acceptPolicyError: 'נא לאשר את תנאי השימוש ומדיניות הפרטיות.',
    continue: 'המשך',
