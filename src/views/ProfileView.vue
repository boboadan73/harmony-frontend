...
const TEXTS = {
  en: {
    ...
    generateRequiredText: 'Your profile was saved successfully. Please click "Generate Matches" and wait a few seconds. Do not close this window.',
  ...
  ar: {
    ...
    generateRequiredText: 'تم حفظ الملف بنجاح. اضغط على "إنشاء المطابقات" وانتظر بضع ثوانٍ.',
  ...
  he: {
    ...
    generateRequiredText: 'הפרופיל נשמר בהצלחה. יש ללחוץ על "צור התאמות" ולהמתין מספר שניות.',
